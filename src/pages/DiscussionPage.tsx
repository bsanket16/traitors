  ...
  return (
    <Stack gap={2}>
      ...
      <Paper elevation={0} sx={{ p: 3, textAlign: 'center' }}>
        <Stack gap={2}>
          <CinematicText phase="Sunrise" title="THE VILLAGE WAKES" lines={[...resultLines, 'Whispers become accusations.', 'Who do you suspect?']} />
          <Typography color="text.secondary">Talk face-to-face. The app stays quiet.</Typography>
          {isOverseer && <Button startIcon={<HowToVote />} variant="contained" onClick={() => action('startVoting')}>Call the Council</Button>}
